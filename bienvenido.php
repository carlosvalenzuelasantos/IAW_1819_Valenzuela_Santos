...
<div class="container">
        ...
        <div class="row justify-content-center align-items-center">
          ...
          <div class="row col-md-offset-6"> 
                      ...
                      <div class="col-md-6">  
                      <h1 align="center">Bienvenido a Peliculas.com</h1>
                      </div>
          ...
          <div class="row col-md-offset-6"> 
                      ...
                      <div class="col-md-6">  
                      <h2 align="center">Ya estas registrado</h2>
                      </div>
           ...
           <div class="row"> 
                    ...
                    <div class="col-md-6">      
                      <a href="index.php">
                      <img border="0" alt="bienvenida" src="images/bienvenido.jpg" ></a>
                    </div>
           ...
           <div class="row"> 
                      ...
                      <div class="col-md-6">  
                      <h3 align="center">Pulsa la imagen para empezar.</h3>
                      </div>
